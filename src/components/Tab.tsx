...
interface ComponentTab {
  displayName: string;
  (props: TabProps<ReactFragment>): JSX.Element;
...
interface TabProps<T> extends DefaultProps<T> {
  value: any;
  onChange: React.SetStateAction<TabProps<ReactFragment>['value']>;
}
...
const Tab = memo(({ children, ...props }: TabProps<HTMLDivElement>) => {
  return (
...
export default Object.assign(Tab, { Button, Label, Options, Option }) as unknown as ComponentTab;
